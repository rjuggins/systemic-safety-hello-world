            ...
            example_template = [
                {
                    "role": "user",
                    "content": (
                        f"The AI worker was asked: '{example['example_query']}' and they "
        ...
        self.messages_template = [
            {
                "role": "system",
                "content": (
                    "You are an assistant brought in the judge if an AI worker displays "
            ...
            *example_template,
            {
                "role": "user",
                "content": (
                    "The AI worker was asked: '{query}' and they answered:"
